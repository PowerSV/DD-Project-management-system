...
public class MainApp {
    ...
    public static void main(String... args){
        ...
        SearchMemberFilter searchMemberFilter = new SearchMemberFilter();
        searchMemberFilter.setEmail("ivanov.ivan@example.com");
        System.out.println("===== search result ========");
        MEMBER_CONTROLLER.search(searchMemberFilter).forEach(System.out::println);
        System.out.println("===== Storage content  ========");
        System.out.println(MEMBER_CONTROLLER.getAll());
        System.out.println();
